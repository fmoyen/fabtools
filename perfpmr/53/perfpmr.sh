...
END {
	...
	printf("%d perfpmr_trace %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s\n",
...
PERFPMRTIME=1247774132   # number of seconds since EPOCH for version of perfpmr
